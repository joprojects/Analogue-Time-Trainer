...
const CaseAndDial = React.memo(({ difficulty, rotation = 0 }) => {
...
const ClockHands = ({ hourRotation, minuteRotation, difficulty, animate, focusMode }) => {
  ...
  const handStyles = { 1: { hour: { w: 8, l: 45 }, minute: { w: 6, l: 68 } }, 2: { hour: { w: 6, l: 55 }, minute: { w: 4, l: 80 } }, 3: { hour: { w: 5, l: 50 }, minute: { w: 3, l: 80 } }, 4: { hour: { w: 2.5, l: 60 }, minute: { w: 1.5, l: 85 } }, 5: { hour: { w: 0, l: 0 }, minute: { w: 0, l: 0 } }, 6: { hour: { w: 0, l: 0 }, minute: { w: 0, l: 0 } },};
...
const Clock = ({ hour, minute, difficulty, focusMode = 'both', timeSetCount = 0, onClick, rotation = 0 }) => {
  ...
  const calculateRotations = useCallback((h, m) => {
    return {
      hour: (h % 12 + m / 60) * 30,
      minute: m * 6,
    };
